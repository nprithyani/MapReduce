...
public class MovieNoRating {
  ...
  public static void main(String[] args) throws IOException {
    ...
    //output folder name is output2
    
    JobConf conf = new JobConf(MovieNoRating.class);
    conf.setJobName("Movie No Rating");
    ...
    conf.setReducerClass(MovieReducerNoRating.class);
